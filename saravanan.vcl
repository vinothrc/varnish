...
acl purge {
  ...
  "192.168.1.0"/24;
  "127.0.0.1"/24;
  "dev-csny.enterpriseapplicationdevelopers.com"/24;
}
...
if (req.http.host == "dev-csny.enterpriseapplicationdevelopers.com" &&
	req.url ~ "^/admin")
{
return (pass);
}
