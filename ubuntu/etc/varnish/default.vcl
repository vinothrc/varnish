 ...
 */
  #      if ( (req.http.host ~ "^(?i)www.example.com" || req.http.host ~ "^(?i)www.composers.com") && req.http.X-Forwarded-Proto !~ "(?i)https") {
  #              return (synth(750, ""));
  #      }
...
return (pass);
  ...
  if (req.url ~ "^/status\.php$" ||
      ...
      req.url ~ "^/content/.*$" ||
      req.url ~ "^/content" ||
      req.url ~ "^/articles/winners-losers/.*$" ||
      req.url ~ "^/articles/winners-losers" ||
      req.url ~ "^/articles/politics/.*$" ||
      req.url ~ "^/articles/politics" ||
...
sub vcl_backend_response {
  ...
  if (bereq.url ~ "^/status\.php$" ||
      ...
      bereq.url ~ "^/content/.*$" ||
      bereq.url ~ "^/content" ||
      bereq.url ~ "^/articles/winners-losers/.*$" ||
      bereq.url ~ "^/articles/winners-losers" ||
      bereq.url ~ "^/articles/politics/.*$" ||
      bereq.url ~ "^/articles/politics" ||
